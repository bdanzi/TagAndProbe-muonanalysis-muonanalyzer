...
if options._beenSet['globalTag'] and options.globalTag != '':
    ...
    #globaltag = '123X_dataRun3_Prompt_v12' if not options.isMC else '122X_mcRun3_2021_realistic_v9'
    ...
    if options.resonance == 'Z':
        if options.isFullAOD:
            if options.isMC:
                ...
                #options.inputFiles.append('/store/data/Run2018B/SingleMuon/AOD/12Nov2019_UL2018-v3/00000/0018DC82-A418-7D46-838C-E54D834F0400.root')
