...
def getOptions():
    ...
    parser.add_option('-w', '--workArea',
                      dest = 'workArea',
                      default = 'crab_MINIAOD_Run2018B_fakerate_deltaR_0p3_ptRel_2p0_tagDeltaZ_1p0_deltaEta_0p4_true_isZmass_70_115',
    ...
    parser.add_option('-f', '--configFile',
                      dest = 'configFile',
                      default = 'MuonAnalysis/MuonAnalyzer/test/run_muonAnalyzer_nic_cfg.py',
    ...
    parser.add_option('-b', '--eraDB',
                      dest = 'eraDB',
                      default = 'MuonAnalysis/MuonAnalyzer/data/samples/muon/Z/Run2018_UL/database.json',
                      #default = 'MuonAnalysis/MuonAnalyzer/data/samples/muon/Z/Run2022/database.json',
...
def main():
    ...
    if crabCmd == 'submit':
        ...
        if storageSite == 'FNAL':
            ...
            config.Data.outLFNDirBase = '/store/group/phys_tracking/%s/crab_AOD_Run2018B_fakerate_deltaR_0p3_ptRel_2p0_tagDeltaZ_1p0_deltaEta_0p4_true_isZmass_70_115/%s/%s/%s/%s' % (getUsername(), particle, resonance, era, dataTier)
        ...
        for subera_name, subera_cfg in samples.items():
            ...
            if isData:
                if 'UL' in era:
                    ...
                    #if '2022' in era:
                    #    config.Data.lumiMask = LM_prefix + ''
                    if '2018' in era:
