...
def getOptions():
    ...
    parser.add_option('-f', '--configFile',
                      dest = 'configFile',
                      default = 'MuonAnalysis/MuonAnalyzer/test/run_muonAnalyzer_nic_cfg_22.py',
...
def main():
    ...
    if crabCmd == 'submit':
        ...
        if storageSite == 'FNAL':
            ...
            config.Data.outLFNDirBase = '/store/group/phys_tracking/%s/TnP_ntuples_MINIAOD_Run2022/%s/%s/%s/%s' % (getUsername(), particle, resonance, era, dataTier)
